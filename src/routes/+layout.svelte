  ...
  <ul role="list" class="flex flex-1 flex-col gap-y-5">
    ...
    {#if option.isSome(sasId)}
      ...
      {:then appModules}
        ...
        {:else}
          <li>
            <div class="text-xs font-semibold leading-6 text-csas-100">App modules</div>
            <ul role="list" class="-mx-2 mt-2 space-y-1">
              {#each appModules.right as module (module.id)}
                <li>
                  <a
                    href="#"
                    class={classNames(
                      selectedAppModuleId === module.id
                        ...
                        : 'text-csas-100 hover:text-white hover:bg-csas-700',
